;if(CloudflareApps.matchPage(CloudflareApps.installs['wMWjoXQ3imH9'].URLPatterns)){(function(){"use strict"
if(!window.addEventListener)return
var options=CloudflareApps.installs['wMWjoXQ3imH9'].options
var element
...
return max}
function inIframe(){try{if("wMWjoXQ3imH9"==='preview'){return window.top!==window.parent.parent}
...
let isConsent=!((!inIframe())&&("wMWjoXQ3imH9"==='preview'||((localStorageValid===false)||(localStorageValid===undefined))));if(!((options.callbackFunction=="")||(options.callbackFunction==null))){window.onload=function(){let fn=window[options.callbackFunction]
...
elementButton.onclick=function(){if("wMWjoXQ3imH9"!='preview'){let fn=window[options.callbackFunction]
